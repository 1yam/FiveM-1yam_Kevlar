...
--------------------------My Pub you can delette if you want but i want to keep 
...
ragdol = false -- Say default Guy don't have Kevlar

-------------------------ESX Thread---------------------

-----------------Principal Thread with all the script------------
